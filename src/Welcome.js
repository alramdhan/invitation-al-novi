        ...
        <>
            ...
            >
                <Modal.Body className={"bg-black"}>
                    <div id="welcome" style={{opacity: 1, paddingTop: 12}}>
                        <div className="d-flex justify-content-center align-items-center">
                            <div className="text-center">
                                <h1 className="font-esthetic mb-4" style={{fontSize: 3.2+"rem"}}>The Wedding Of</h1>

                                <div className="col-12 img-crop border border-3 border-light mb-4 mx-auto rounded-circle" style={{
                                    width: 64+"%",
                                    height: 190,
                                ...
                                <h1 className="font-esthetic my-4" style={{fontSize: 2.5+"rem"}}>Al &amp; Novi</h1>
                                <div style={{height: 50}}></div>
                                <div id="guest-name" style={{color: "#E2E2EF"}}>Kepada Yth Bapak/Ibu/Saudara/i</div>
                                <h3 className='mb-3' style={{color: "#E2E2EF"}}>{queryParam.get("to")}</h3>
